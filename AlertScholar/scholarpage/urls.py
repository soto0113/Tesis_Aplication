...
from .views import view_estudiante, create_estudiante, delete_estudiante, edit_estudiante, base, login_estudiante,logout_estudiante, carga_excel, regresion_bosques_aleatorios
...
urlpatterns = [
    ...
    path('regresion-bosques-aleatorios/', regresion_bosques_aleatorios, name='regresion_bosques_aleatorios'),
